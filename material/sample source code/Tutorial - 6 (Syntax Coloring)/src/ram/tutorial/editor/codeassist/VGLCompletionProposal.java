 ...
 *
 */
public class VGLCompletionProposal implements ICompletionProposal,
		ICompletionProposalExtension2, ICompletionProposalExtension4,
		Comparable<VGLCompletionProposal> {
	...
	public VGLCompletionProposal (String proposal, int type)
	{
	...
	@Override
	public int compareTo(VGLCompletionProposal o) {
